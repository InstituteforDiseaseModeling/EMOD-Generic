...
def doitall( ext_name, src_list ):
    ...
    compiler_args.extend( [ "-DDISABLE_AIRBORNE", "-DDISABLE_HIV", "-DDISABLE_STI", "-DDISABLE_VECTOR", "-DDISABLE_MALARIA", "-DDISABLE_CLIMATE" ] )
    ...
    setup (name = ext_name,
            version = '1.0',
            description = 'Python module consisting of IDM DTK Node functionality.',
            ext_modules = [module1]) 
