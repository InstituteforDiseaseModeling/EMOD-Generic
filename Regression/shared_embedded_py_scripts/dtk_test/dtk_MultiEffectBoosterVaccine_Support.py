...
class CampaignKeys:
    ...
    INITIAL_ACQUIRE_BY_CURRENT_EFFECT_MULTIPLIER = "Initial_Acquire_By_Current_Effect_Multiplier"
    INITIAL_TRANSMIT_BY_CURRENT_EFFECT_MULTIPLIER = "Initial_Transmit_By_Current_Effect_Multiplier"
    INITIAL_MORTALITY_BY_CURRENT_EFFECT_MULTIPLIER = "Initial_Mortality_By_Current_Effect_Multiplier"
    VALUES = "Values"
...
def parse_vax_event(campaign_filename, prime_group_event, debug):
    ...
    vax_event_obj[CampaignKeys.PRIME_ACQUIRE] = \
       cf[prime_group_event][CampaignKeys.EVENT_COORDINATOR_CONFIG][CampaignKeys.INTERVENTION_CONFIG][CampaignKeys.ACQUIRE_CONFIG][CampaignKeys.INITIAL_EFFECT]
    vax_event_obj[CampaignKeys.PRIME_TRANSMIT] = \
        cf[prime_group_event][CampaignKeys.EVENT_COORDINATOR_CONFIG][CampaignKeys.INTERVENTION_CONFIG][CampaignKeys.TRANSMIT_CONFIG][CampaignKeys.INITIAL_EFFECT]
    vax_event_obj[CampaignKeys.PRIME_MORTALITY] = \
        cf[prime_group_event][CampaignKeys.EVENT_COORDINATOR_CONFIG][CampaignKeys.INTERVENTION_CONFIG][CampaignKeys.MORTALITY_CONFIG][CampaignKeys.INITIAL_EFFECT]


    vax_event_obj[CampaignKeys.BOOST_ACQUIRE] = vax_event_obj[CampaignKeys.PRIME_ACQUIRE] * \
       cf[prime_group_event][CampaignKeys.EVENT_COORDINATOR_CONFIG][CampaignKeys.INTERVENTION_CONFIG][CampaignKeys.INITIAL_ACQUIRE_BY_CURRENT_EFFECT_MULTIPLIER][CampaignKeys.VALUES][-1]
    vax_event_obj[CampaignKeys.BOOST_TRANSMIT] = vax_event_obj[CampaignKeys.PRIME_TRANSMIT] * \
        cf[prime_group_event][CampaignKeys.EVENT_COORDINATOR_CONFIG][CampaignKeys.INTERVENTION_CONFIG][CampaignKeys.INITIAL_TRANSMIT_BY_CURRENT_EFFECT_MULTIPLIER][CampaignKeys.VALUES][-1]
    vax_event_obj[CampaignKeys.BOOST_MORTALITY] = vax_event_obj[CampaignKeys.PRIME_MORTALITY] * \
        cf[prime_group_event][CampaignKeys.EVENT_COORDINATOR_CONFIG][CampaignKeys.INTERVENTION_CONFIG][CampaignKeys.INITIAL_MORTALITY_BY_CURRENT_EFFECT_MULTIPLIER][CampaignKeys.VALUES][-1]
