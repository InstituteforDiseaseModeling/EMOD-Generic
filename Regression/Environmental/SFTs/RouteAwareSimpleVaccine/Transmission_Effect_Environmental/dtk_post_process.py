...
Testing Vaccine Effect in RouteAwareSimpleVaccine with TransmissionBlocking and TRANSMISSIONROUTE_ENVIRONMENTAL
...
def application(output_folder="output", stdout_filename="test.txt",
    ...
    RASV_support.create_report_file_transmission_effect(df, property_report_name, config_filename, report_name)
