...
import dtk_test.dtk_Contact_Contagion_HINT_Support as cch_support
...
def application(output_folder="output", stdout_filename="test.txt",
    ...
    config_obj = hint_support.load_config_parameters(config_filename, cch_support.config_keys, debug)
    ...
    property_keys = hint_support.build_channel_string_for_property(property_list, cch_support.channels, debug)
    ...
    inset_chart_obj = General_Support.parse_inset_chart(output_folder, insetchart_name, cch_support.inset_channels, debug)
    cch_support.create_report_file(config_obj, property_df, property_obj, inset_chart_obj, insetchart_name, property_report_name,
                       report_name, debug)
