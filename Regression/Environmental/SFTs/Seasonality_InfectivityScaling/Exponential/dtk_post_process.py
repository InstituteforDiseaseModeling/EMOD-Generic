...
import dtk_test.dtk_InfectivityScalingExponential_Support as Exponential_Support

"""

This SFT is testing the environmental seasonality with "Infectivity_Scale_Type": "EXPONENTIAL_FUNCTION_OF_TIME"(
...
Suggested sweep parameters: Environmental_Peak_Start, Environmental_Ramp_Down_Duration, Environmental_Cutoff_Days
                            Environmental_Ramp_Up_Duration, Infectivity_Exponential_Baseline,
                            Infectivity_Exponential_Delay, Infectivity_Exponential_Rate
...
config_keys = [ConfigKeys.Config_Name, ConfigKeys.Simulation_Timestep,
               ...
               ConfigKeys.Infectivity_Exponential_Delay,
               ConfigKeys.Infectivity_Exponential_Rate]
...
def create_report_file(param_obj, stdout_df, property_obj, property_df, report_name, debug):
    with open(report_name, "w") as outfile:
        ...
        sft.plot_data(property_df[channels[3]][1:], expected_contagion_e_list[1:],
                      label1="Actual",
                      label2="Expected",
                      title="Environmental Contagion\nSeasonality_Exponential", xlabel="Day",
