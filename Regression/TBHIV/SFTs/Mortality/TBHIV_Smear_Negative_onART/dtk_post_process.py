...
def create_report_file(data):
    ...
    with open(report_name, "w") as outfile:
        ...
        sft.plot_data(sorted(time_to_death_data), sorted(expected_data), label1="Actual", label2="Expected",
                          title="Time from Smear Negative on ART TBHIV to Death", xlabel="Data Points", ylabel="Days",
                          category="tbhiv_mortality_smear_negative_on_art", line = True, overlap=True)
