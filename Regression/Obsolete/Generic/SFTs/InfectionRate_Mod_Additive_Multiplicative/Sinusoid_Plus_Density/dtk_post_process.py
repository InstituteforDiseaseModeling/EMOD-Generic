...
def application( output_folder="output", stdout_filename="test.txt", insetchart_name="InsetChart.json",
    ...
    enabled_param = [IRMAM_support.Config.enable_infectivity_scaling,
                     IRMAM_support.Config.enable_infectivity_sinusoid,
                     IRMAM_support.Config.enable_infectivity_density]
    IRMAM_support.create_report_file(enabled_param, param_obj, campaign_obj, demo_obj, stdout_df, insetchart_df,
                                     report_name, debug)
