...
def parse_stdout_file(stdout_filename="StdOut.txt", simulation_timestep=1, debug=False):
    ...
    ip_value = ""
    test_positive = test_negative = test_default = outbreak = 0
    for line in filtered_lines:
        ...
        elif matches[4] in line:
            outbreak = int(sft.get_val(Stdout.gave_out_outbreak, line))
