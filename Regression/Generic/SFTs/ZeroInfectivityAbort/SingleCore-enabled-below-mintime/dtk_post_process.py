...
GIVEN a single core generic simulation AND Zero Infectivity Termination enabled,
WHEN there is zero infectivity before Minimum_End_Time AND the simulation has passed Minimum_End_Time 
