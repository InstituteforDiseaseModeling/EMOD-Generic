...
class SerializedInfection:
    def __init__(self, json_infection, human_suid):
        ...
        self.strain_clade   = infection_strain['cladeID']
    ...
    def compare_to_older(self, older_infection, time_since_older):
        ...
        if self.strain_clade != older_infection.strain_clade:
            messages.append(f"BAD: {self.name} used to have clade {older_infection.strain_clade} and now has {self.strain_clade}")
