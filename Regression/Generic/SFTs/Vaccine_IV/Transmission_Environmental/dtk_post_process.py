...
Testing Vaccine Effect in Vaccine with TransmissionBlocking and ENVIRONMENTAL
...
def application(output_folder="output", stdout_filename="test.txt",
    ...
    RASV_support.create_report_file_transmission_effect(df, property_report_name, config_filename, report_name, env_targ)
