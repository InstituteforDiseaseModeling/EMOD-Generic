...
This SFT is testing the HIVDeaths column in the Report_TBHIV_ByAge.csv match the count for deaths due to HIV in stdout.txt.
...
def application( output_folder="output", stdout_filename="test.txt", reporter_filename="Report_TBHIV_ByAge.csv",
    ...
    output_dict = trs.parse_output_file(matches, ReportColumn.hivdeaths, stdout_filename,
    ...
    trs.create_report_file_incidence(ReportColumn.hivdeaths, ReportColumn.year, param_obj, output_dict,
                                     reporter_df,
                                     report_name, debug)
