...
public:
    ...
    virtual void AcquireNewInfection(const Kernel::IStrainIdentity*, float)                        override { throw Kernel::NotYetImplementedException( __FILE__, __LINE__, __FUNCTION__, "The method or operation is not implemented."); }
