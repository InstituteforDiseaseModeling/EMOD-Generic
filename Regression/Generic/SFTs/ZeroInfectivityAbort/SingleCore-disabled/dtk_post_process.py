...
GIVEN a single core generic simulation AND Zero Infectivity Termination disabled,
WHEN there is zero infectivity before Simulation_Duration AND the simulation reaches Simluation_Duration 
