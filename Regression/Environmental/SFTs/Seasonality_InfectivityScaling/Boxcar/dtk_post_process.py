...
This SFT is testing the environmental seasonality with "Infectivity_Scale_Type": "ANNUAL_BOXCAR_FUNCTION"(
...
Suggested sweep parameters: Environmental_Peak_Start, Environmental_Ramp_Down_Duration, Environmental_Cutoff_Days
                            Environmental_Ramp_Up_Duration, Infectivity_Boxcar_Forcing_Start_Time,
                            Infectivity_Boxcar_Forcing_Start_Time, Infectivity_Boxcar_Forcing_Amplitude
