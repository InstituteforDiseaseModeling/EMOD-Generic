...
def create_report_file(param_obj, output_dict, report_name, debug):
    with open(report_name, "w") as outfile:
        ...
        sft.plot_data_sorted(cure_timer, dist2=np.array(dist_exponential_np), label1="cure timer",
        ...
        result = sft.test_exponential(cure_timer, p1=cure_rate, report_file=outfile, integers=False, roundup=False,
                                          round_nearest=False)
