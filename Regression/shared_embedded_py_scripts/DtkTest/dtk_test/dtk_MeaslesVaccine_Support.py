...
class CampaignKeys:
    VACCINE_TAKE_VS_AGE_MAP = "Take_By_Age_Multiplier"
    ...
    TIMES = "Times"
    VALUES = "Values"
    EXISTING_ANTIBODY_BLOCKING_MULTIPLIER = "Take_Reduced_By_Acquire_Immunity"
...
def create_report_file(param_obj, campaign_obj, report_name, stdout_filename,
    ...
    test_values = [t * (1-campaign_obj[CampaignKeys.EXISTING_ANTIBODY_BLOCKING_MULTIPLIER]) for t in test_values]
